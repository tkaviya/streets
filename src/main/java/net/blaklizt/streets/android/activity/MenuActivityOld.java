...
//
//public class MenuActivity extends AppCompatActivity implements View.OnClickListener, DialogInterface.OnClickListener,
//        DialogInterface.OnMultiChoiceClickListener, NavigationView.OnNavigationItemSelectedListener {
//
...
//    protected TextView mLeftMenuHeaderText;
...
//
//        Log.i(TAG, "Creating action bar");
//        final ActionBar ab = getSupportActionBar();
//        ab.setHomeAsUpIndicator(R.drawable.ic_play_dark);
//        ab.setDisplayHomeAsUpEnabled(true);
//        ab.setHomeButtonEnabled(true);
//
//        Log.i(TAG, "Creating left menu header");
//        mLeftMenuHeaderText = (TextView) findViewById(R.id.menu_left_header_text);
//        mLeftMenuHeaderText.setText(Startup.getStreetsCommon().getSymbiosisUser().username);
//
//        Log.i(TAG, "Creating left sidebar");
