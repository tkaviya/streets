package net.baeldung.web.controller;

import java.util.List;

import javax.servlet.http.HttpServletResponse;

import net.baeldung.persistence.service.IFooService;
import net.baeldung.web.hateoas.event.PaginatedResultsRetrievedEvent;
import net.baeldung.web.hateoas.event.SingleResourceRetrievedEvent;
import net.baeldung.web.util.RestPreconditions;
import net.baeldung.persistence.model.Foo;
import net.baeldung.web.exception.MyResourceNotFoundException;
import net.baeldung.web.hateoas.event.ResourceCreatedEvent;
