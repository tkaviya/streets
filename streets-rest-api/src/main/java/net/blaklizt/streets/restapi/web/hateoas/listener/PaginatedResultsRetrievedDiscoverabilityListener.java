package net.blaklizt.streets.restapi.web.hateoas.listener;

import javax.servlet.http.HttpServletResponse;

import net.blaklizt.streets.restapi.web.hateoas.event.PaginatedResultsRetrievedEvent;
import net.blaklizt.streets.restapi.web.util.LinkUtil;
